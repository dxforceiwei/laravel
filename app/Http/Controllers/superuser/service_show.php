...
class service_show extends Controller
{
    public function index()
    {
        $currentPage = "/traffic_system/public/superuser/service_show";
		...
		$query_Recordset1 = DB::select("SELECT * FROM `add_service` ORDER BY id desc LIMIT ".$startRow_Recordset1.",".$maxRows_Recordset1);
		...
		{
		  $totalRows_Recordset2 = DB::table('add_service')->orderBy('id','desc')->count();
		}
		...
		return view('superuser/service_show')->with('all', $query_Recordset1)
